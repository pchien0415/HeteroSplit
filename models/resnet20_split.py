...
class ResNet20_split_2(nn.Module):
    def __init__(self, num_classes=10):
        super(ResNet20_split_2, self).__init__()
...
class ResNet20_split_2to4(nn.Module):
    def __init__(self, num_classes=10):
        super(ResNet20_split_2to4, self).__init__()
...
class ResNet20_split_3to4(nn.Module):
    def __init__(self, num_classes=10):
        super(ResNet20_split_3to4, self).__init__()
...
class ResNet20_split_06to2(nn.Module):
    def __init__(self, num_classes=10):
        super(ResNet20_split_06to2, self).__init__()
        self.block2 = BasicBlock(16, 16)
...
class ResNet20_split_06to4(nn.Module):
    def __init__(self, num_classes=10):
        super(ResNet20_split_06to4, self).__init__()
        self.block2 = BasicBlock(16, 16)
...
class ResNet20_split_026to2(nn.Module):
    def __init__(self, num_classes=10):
        super(ResNet20_split_026to2, self).__init__()
        self.block1 = BasicBlock(16, 16)
        self.block2 = BasicBlock(16, 16)
...
class ResNet20_split_026to4(nn.Module):
    def __init__(self, num_classes=10):
        super(ResNet20_split_026to4, self).__init__()
        self.block1 = BasicBlock(16, 16)
        self.block2 = BasicBlock(16, 16)
