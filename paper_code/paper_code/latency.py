...
# Propose 加上傳輸時間
latency = 0
latency += calculate_round_latency(model_level05, devices["Weak"])
latency += calculate_round_latency(model_level05_2, devices["Medium"])
latency = latency * epoch
latency_try = 0
latency_try += calculate_round_latency(model_level025, devices["Weak"])
latency_try += calculate_round_latency(model_level025_4, devices["Strong"])
